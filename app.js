...
var upload = multer({ dest:'./public/uploads/', limits: { fileSize: 1000000,
                                                          files: 1}});
...
app.use(requre('node-sass-middleware')({
...
app.use(session({
  ...
  resave: true,
  // store session on MongoDB using express-session + connect monog
